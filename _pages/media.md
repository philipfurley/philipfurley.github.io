...
<style>
/* Layout Container: Sidebar + Content Area */
...
/* Sidebar Styling matching Research Page */
.media-sidebar {
  width: 240px;
  flex-shrink: 0;
  position: sticky;
  top: 90px;
  background: var(--global-card-bg, #ffffff);
  border: 1px solid var(--global-divider-color, #eaeaea);
  border-radius: 8px;
...
.media-sidebar-title {
  ...
  border-bottom: 1px solid var(--global-divider-color, #eaeaea);
}
...
/* Hidden elements class for Toggle functionality */
...
/* Dark Mode Overrides */
html[data-theme='dark'] .media-sidebar,
html[data-theme='dark'] .featured-media-box {
  background: #222224 !important;
  border-color: #333336 !important;
}

html[data-theme='dark'] .featured-media-box {
  border-color: var(--global-theme-color, #007bff) !important;
}

html[data-theme='dark'] .media-sidebar-title {
  color: #f4f4f5 !important;
  border-bottom-color: #333336 !important;
}
...
<p style="margin-bottom: 1.5rem; color: var(--global-text-color-light, #4a5568);">
  ...
  <div class="media-grid">
    <a href="https://www.nytimes.com/2018/07/10/sports/world-cup/england-croatia-france-belgium.html" target="_blank" rel="noopener noreferrer" class="media-card">
      ...
      <div class="media-body">
        <div class="media-outlet">The New York Times</div>
        <div class="media-title">Why does every soccer player show this gesture?</div>
        <p class="media-description">Feature detailing psychological penalty shoot-out dynamics, gaze avoidance, and nonverbal signaling under pressure.</p>
      </div>
    </a>
    ...
    <a href="https://www.theguardian.com/sport/2025/oct/13/luke-littler-poker-face-key-to-dominance-darts" target="_blank" rel="noopener noreferrer" class="media-card">
      ...
      <div class="media-body">
        ...
        <p class="media-description">Thin-slice research analyzing facial composure, action coding (FACS), and performance predictability in professional sports.</p>
      </div>
    </a>
  </div>
</div>
...
<div class="media-layout-container">
  ...
  <aside class="media-sidebar">
    ...
    <ul class="media-nav-list">
      <li><a href="#awards" class="media-nav-link active">1. Major Science Awards</a></li>
      <li><a href="#print-press" class="media-nav-link">2. International Press</a></li>
      <li><a href="#broadcast" class="media-nav-link">3. Broadcast &amp; Podcasts</a></li>
      <li><a href="#directory" class="media-nav-link">4. Institutional Directory</a></li>
    </ul>
  </aside>
      ...
      <div class="media-wrapper">
        <div class="media-grid">
          ...
          <a href="https://www.sport1.de/news/olympia/2023/02/dosb-wissenschaftspreis-an-philip-furley-verliehen" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">SPORT1 • Feb 2023</div>
              <div class="media-title">DOSB-Wissenschaftspreis an Philip Furley verliehen</div>
              <p class="media-description">Awarding of 1st Place in the prestigious DOSB Science Award for outstanding habilitation research in sport science.</p>
            </div>
          </a>

          <a href="https://www.dshs-koeln.de/aktuelles/meldungen-details/meldung/dosb-wissenschaftspreis-1/" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <i class="fa-solid fa-graduation-cap media-thumb-placeholder"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">DSHS Köln News • Feb 2023</div>
              <div class="media-title">Erster Preis beim DOSB-Wissenschaftspreis für Dr. Philip Furley</div>
              <p class="media-description">Institutional announcement honoring top national recognition by the German Olympic Sports Confederation.</p>
            </div>
          </a>

          <a href="https://www.jungewelt.de/artikel/442675.sportwissenschaft-ohne-worte-i.html" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <img src="https://img.logo.dev/jungewelt.de?token=pk_X1-Y3111T-29_7-1111111" alt="junge Welt" class="media-thumb" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
              <i class="fa-solid fa-newspaper media-thumb-placeholder" style="display:none;"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">junge Welt • Jan 2023</div>
              <div class="media-title">Sportwissenschaft: Ohne Worte (I)</div>
              <p class="media-description">Feature on award-winning research analyzing nonverbal communication and body language in sports.</p>
            </div>
          </a>

          <a href="https://www.forschung-und-lehre.de/karriere/preise/preise-mai-2023-5575" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <i class="fa-solid fa-certificate media-thumb-placeholder"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">Forschung &amp; Lehre • May 2023</div>
              <div class="media-title">DOSB Wissenschaftspreis – Auszeichnungen</div>
              <p class="media-description">Academic registry listing top award distinctions across German higher education institutions.</p>
            </div>
          </a>

        </div>
        <button class="media-toggle-btn" onclick="toggleMedia(this)">+ Show more media coverage</button>
      </div>
    </section>
        ...
        <div class="media-grid">
          ...
          <a href="https://www.nytimes.com/2018/07/10/sports/world-cup/england-croatia-france-belgium.html" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">The New York Times</div>
              <div class="media-title">Why does every soccer player show this gesture?</div>
              <p class="media-description">Feature detailing psychological penalty shoot-out dynamics, gaze avoidance, and 'hastening and hiding' behaviors.</p>
            </div>
          </a>
          ...
          <a href="https://www.theguardian.com/sport/2025/oct/13/luke-littler-poker-face-key-to-dominance-darts" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">The Guardian • Oct 2025</div>
              <div class="media-title">Luke Littler's Poker Face May Be the Key to His Dominance in Darts</div>
              <p class="media-description">Thin-slice research analyzing facial composure, action coding (FACS), and performance predictability in professional darts.</p>
            </div>
          </a>
          ...
          <a href="https://www.nytimes.com/athletic/7090564/2026/03/06/kevin-durant-caleb-williams-body-language-expert/" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">The New York Times / The Athletic • March 2026</div>
              <div class="media-title">What Body Language Expert Analysis Tells Us About Kevin Durant &amp; Caleb Williams</div>
              <p class="media-description">In-depth nonverbal analysis decoding micro-expressions and emotional regulation in high-stakes professional athletics.</p>
            </div>
          </a>
          ...
          <a href="https://www.theguardian.com/sport/blog/2021/dec/27/like-a-red-rag-to-a-tiger-academics-argue-on-shirt-colour-affecting-results" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">The Guardian • Dec 2021</div>
              <div class="media-title">Like a Red Rag to a Tiger: Can Shirt Colours Really Affect Results in Sport?</div>
              <p class="media-description">Critical review evaluating the red shirt color hypothesis and meta-analytic evidence across European football leagues.</p>
            </div>
          </a>
          ...
          <a href="https://www.spiegel.de/wissenschaft/mensch/fussball-bundesliga-koerpersprache-verraet-unsicherheit-von-schiedsrichtern-a-1144222.html" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">DER SPIEGEL • April 2017</div>
              <div class="media-title">Körpersprache verrät Unsicherheit von Schiedsrichtern</div>
              <p class="media-description">Point-light display studies demonstrating nonverbal indicators of referee uncertainty in professional soccer.</p>
            </div>
          </a>

          <a href="https://www.independent.co.uk/life-style/lionesses-chloe-kelly-shirt-celebration-b2136200.html" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <img src="https://img.logo.dev/independent.co.uk?token=pk_X1-Y3111T-29_7-1111111" alt="The Independent" class="media-thumb" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
              <i class="fa-solid fa-heart media-thumb-placeholder" style="display:none;"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">The Independent • Aug 2022</div>
              <div class="media-title">Chloe Kelly Proved It’s Not Just Male Footballers Who Love to Rip Off Their Shirts</div>
              <p class="media-description">Analysis of nonverbal expressions of pride, emotional release, and high-pressure goal celebrations.</p>
            </div>
          </a>

          <a href="https://www.huffingtonpost.co.uk/dr-raj-persaud/inside-the-mind-of-the-pe_b_1624132.html" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <img src="https://img.logo.dev/huffingtonpost.co.uk?token=pk_X1-Y3111T-29_7-1111111" alt="HuffPost UK" class="media-thumb" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
              <i class="fa-solid fa-brain media-thumb-placeholder" style="display:none;"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">HuffPost UK • June 2012</div>
              <div class="media-title">Inside the Mind of the Penalty Taker: Can Psychology Explain Shootouts?</div>
              <p class="media-description">Exploring gaze behavior, pre-performance routines, and psychological pressure during penalty shootouts.</p>
            </div>
          </a>

          <a href="https://idw-online.de/de/news560979" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              ...
              <i class="fa-solid fa-rss media-thumb-placeholder" style="display:none;"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">idw Nachrichten • Nov 2013</div>
              <div class="media-title">Der Ausdruck von Sieg und Niederlage im Sport</div>
              <p class="media-description">Investigating nonverbal expressions of pride and shame across elite international competitive sports.</p>
            </div>
          </a>
      ...
      <div class="media-wrapper">
        <div class="media-grid">
          ...
          <a href="https://www.deutschlandfunkkultur.de/koerpersprache-sport-100.html" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">Deutschlandfunk Kultur • Aug 2022</div>
              <div class="media-title">Körpersprache im Sport – Kopf hoch und klare Ansage</div>
              <p class="media-description">Radio feature examining power posing, nonverbal signaling, and feedback loops in elite team sports.</p>
            </div>
          </a>
          ...
          <a href="https://www.youtube.com/watch?v=1Cf2xoYlSCY" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">DSHS Wissenschaftspodcast • Aug 2026</div>
              <div class="media-title">#54 Dr. Philip Furley – Spielgesten &amp; Nonverbale Kommunikation</div>
              <p class="media-description">Podcast episode focusing on subtle game gestures, self-control, and working memory performance under pressure.</p>
            </div>
          </a>

          <a href="https://behavior-podcast.com/learnings-from-studying-nonverbal-behavior-in-sports-with-philip-furley/" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <i class="fa-solid fa-microphone-lines media-thumb-placeholder"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">Behavioral Sports Psychology Podcast • Feb 2023</div>
              <div class="media-title">Studying Nonverbal Behavior in Competitive Sport Scenarios</div>
              <p class="media-description">Technical discussion on point-light displays, thin-slice predictions, and keeper-dependent penalty strategies.</p>
            </div>
          </a>
      ...
      <div class="media-wrapper">
        <div class="media-grid">
          ...
          <a href="https://fis.dshs-koeln.de/de/clippings/warum-machen-das-so-wenige-ein-elfmeter-in-diese-ecke-geht-fast-i/" target="_blank" rel="noopener noreferrer" class="media-card">
            ...
            <div class="media-body">
              <div class="media-outlet">DSHS Media Directory • July 2026</div>
              <div class="media-title">Warum machen das so wenige? Ein Elfmeter in diese Ecke geht fast immer rein</div>
              <p class="media-description">Feature analyzing penalty placement probabilities and psychological decision-making under pressure.</p>
            </div>
          </a>
          ...
          <a href="https://fis.dshs-koeln.de/de/persons/philip-furley/" target="_blank" rel="noopener noreferrer" class="media-card">
            <div class="media-thumb-container">
              <i class="fa-solid fa-arrow-trend-up media-thumb-placeholder"></i>
            </div>
            <div class="media-body">
              <div class="media-outlet">DSHS FIS Registry</div>
              <div class="media-title">PD Dr. Philip Furley – Complete Press &amp; Publication Profile</div>
              <p class="media-description">Official university database linking DFG grants, research projects, media clippings, and academic literature.</p>
            </div>
          </a>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const links = document.querySelectorAll(".media-nav-link");
...
function toggleMedia(button) {
  ...
  const hiddenCards = wrapper.querySelectorAll(".media-grid > .media-card.media-hidden");
  const allCards = wrapper.querySelectorAll(".media-grid > .media-card");
